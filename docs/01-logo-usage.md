...
The identity is walnut and brass prairie arcade joystick. It follows the reviewed Hexly material study `2026-09-07-01`, finishing `02`.
...
- `assets/brand/background.png`: independent prairie suntracks field.
...
[Individual comparison](https://hexly.ai/logos/pew-game) · [Complete generation archive](https://github.com/nocoo/hexly.ai/tree/main/artwork/logo-family/pew-game/2026-09-07-01) · [Shared usage SOP](https://github.com/nocoo/hexly.ai/blob/main/docs/07-logo-usage-sop.md)
